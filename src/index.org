...
src_dir="$HOME/repos/"
dest_dir="$HOME/Dropbox/repos/"

# run the sync
rsync -arv --delete-after --delete-excluded --progress \
  --filter="dir-merge,- .gitignore" \
  --exclude-from="$HOME/.gitignoreglobal" \
  --chmod="F-w" \
  "$src_dir" "$dest_dir"
    #+END_SRC
...
- [[https://magit.vc/][It's Magit! A Git Porcelain inside Emacs]]
  status buffer
- [[https://github.com/hlissner/emacs-solaire-mode][hlissner/ *emacs-solaire-mode*]] - helps visually distinguish visiting windows
  from other types of windows by giving them a slightly different background
